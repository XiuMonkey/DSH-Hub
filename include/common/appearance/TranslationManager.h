...
//
// .ts 里只写 <message id="key"> + <translation>：id 是查表主键；<source> 不参与
// 查表，也不在运行期使用，正式 .ts 不维护 <source>（写了也会被
// tools/release-translations.ps1 删掉）。原文由 zh_CN 的 <translation> 承担。
//
