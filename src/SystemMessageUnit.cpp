    ...
    : QTextBrowser(parent)
{
    ...
    // 无边框、透明背景、斜体浅灰文字
    setStyleSheet(QStringLiteral("SystemMessageUnit {") + QStringLiteral("  background: transparent;") + QStringLiteral("  border: none;") + QStringLiteral("  color: ") + QStringLiteral("#999999") + QStringLiteral(";") + QStringLiteral("  font-style: italic;") + QStringLiteral("}"));
