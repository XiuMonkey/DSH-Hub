    ...
    : QPushButton(QStringLiteral("模型设置"), parent)
{
    ...
    setStyleSheet(QStringLiteral(
        "QPushButton#modelSettingsButton {"
        ...
        "  text-align: left;"
        "}"
        "QPushButton#modelSettingsButton:hover,"
        "QPushButton#modelSettingsButton:checked {"
        "  background: #F3F4F6;"
        "}"
        "QPushButton#modelSettingsButton:pressed {"
        "  background: #E5E7EB;"
        "}"
    ));
}
    ...
    , m_credentialsFile(dshHome.isEmpty() ? QString() : dshHome + QStringLiteral("/.credentials.yaml"))
{
    ...
    apiLabel->setStyleSheet(QStringLiteral(
        "QLabel {"
        "  background: transparent;"
        "  color: #6B7280;"
        "  font-size: 12px;"
    ...
    modelEdit->setStyleSheet(QStringLiteral(
        ...
        "}"
        "QLineEdit#modelSettingsEdit:focus {"
        "  background: #FFFFFF;"
        "  border-color: #4C8BF5;"
        "}"
    ));
