...
UserMessageUnit *MessageQuery::addUserMessage(const QString &text, QVBoxLayout *layout)
{
    ...
    copyButton->setStyleSheet(QStringLiteral("QPushButton {") + QStringLiteral("  border: none;") + QStringLiteral("  background: transparent;") + QStringLiteral("  color: ") + QStringLiteral("#666666") + QStringLiteral(";") + QStringLiteral("  font-size: 14px;") + QStringLiteral("  border-radius: 4px;") + QStringLiteral("  padding: 0px;") + QStringLiteral("  margin: 0px;") + QStringLiteral("}") + QStringLiteral("QPushButton:hover {") + QStringLiteral("  background: rgba(0,0,0,0.08);") + QStringLiteral("  color: ") + QStringLiteral("#222222") + QStringLiteral(";") + QStringLiteral("}") + QStringLiteral("QPushButton:pressed {") + QStringLiteral("  background: rgba(0,0,0,0.12);") + QStringLiteral("}"));
